...
public class QrPdf {
	/**
	 * This custom file attribute is used to add the QR code to the PDF file
	 * meta data.
	 */
	 ...
	 *
	 * <p>
	 * A valid QR code is A-Z, a-z, 0-9, space, dash (-) or underscore (_). This
	 * strict pattern is used to avoid trouble with file names etc. Although
	 * spaces are allowed, be cautious, as a starting or trailing space may
	 * cause trouble.
	 * </p>
	 *
	 * @param code
	...
	/**
	 * Gets creation time of the QR PDF (if this attribute is supported by the
	 * file system).
	 *
	 * @return FileTime attribute of creation.
	 * @throws IOException
	 *             Unable to determine date/time.
	 */
	 ...
	 * @throws IOException
	 *             if unable to determine number of pages
	 */
	 ...
	 * 
	 * <p>
	 * You may chose to use the file attribute <i>custom.qrcode</i> as if it was
	 * the actual QR code in the file. Only use this if you trust the file
	 * attribute.
	 * </p>
	 *
	 * <p>
	 ...
	 *
	 * @param page
	 *            page where QR code is placed (starting at 1)
	 * @param useQRCodeFileAttribute
	 *            whether to use the file attribute to find an associated QR code
	 * @param writeFileAttributes
	 *            whether to write the custom file attribute to the PDF file if
	 *            a QR code was found while scanning. If the file already has a
	 *            custom file attribute, it is updated. If the file attribute
	 *            could not be written, it fails silently.
	 * @return QR code that was extracted
	 * @throws IOException
	 *             if reading file failed or no such page
	 * @throws NotFoundException
	 *             if QR code recognition failed
	 */
	 ...
	 * 
	 * <p>
	 * Note: only use this for operations if you trust that no incorrect QR
	 * codes are stored as file attributes.
	 * </p>
	 *
	 * @return QR code
	 * @throws IOException
	 *             if file not found, QR code not in an attribute, or illegal QR
	 *             code.
	 */
	...
	/**
	 * Checks whether this PDF has a (valid) QR code in the custom file
	 * attribute.
	 * 
	 ...
	 * 
	 * @param code
	 *            code to store as file attribute
	 * @throws IOException
	 *             if file attribute could not be saved
	 * @throws IllegalArgumentException
	 *             if code contain illegal characters
	 */
