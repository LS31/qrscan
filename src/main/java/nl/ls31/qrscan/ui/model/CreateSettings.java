...
public class CreateSettings {
	...
	/**
	 * Gets the input file path setting. The path may be invalid and the file
	 * may not exist.
	 * 
	...
	/**
	 * Gets the output directory setting. The path may be invalid and the
	...
	/**
	 * Gets the setting whether the images should be annotated with human
	 * readable text.
	 * 
	...
	/**
	 * Sets the input file path setting where a text file with requested QR
	 * codes can be found. This does not check the validity of the path.
	 * 
	 * @param file
	 *            input file path
	 */
	...
	/**
	 * Sets the output directory path setting, where QR images will be stored.
	 * This does not check the validity of the path.
	 * 
	 * @param directory
	...
	/**
	 * Sets the setting whether the images should be annotated with human
	 * readable text.
	 * 
	 * @param withAnnotation
	 *            whether to add annotation
	 */
